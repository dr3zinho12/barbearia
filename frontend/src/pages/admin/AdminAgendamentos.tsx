...
import { Appointment, AppointmentStatus, Barber, PaginatedResult, Service, User } from '../../types';
...
export default function AdminAgendamentos() {
  ...
  const [result, setResult] = useState<PaginatedResult<Appointment> | null>(null);

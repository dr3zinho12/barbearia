    ...
    <div className="mx-auto max-w-2xl space-y-8">
      ...
      <div className="card p-6">
        ...
        <p className="mt-2 text-xs text-slate-500">
          Para renomear o sistema, altere <code className="rounded bg-white/5 px-1.5 py-0.5">frontend/src/config/brand.js</code>{' '}
          e <code className="rounded bg-white/5 px-1.5 py-0.5">backend/src/config/business.js</code>.
        </p>
      </div>

...
import { barbersService, BarberBreakPayload } from '../../services/barbers.service';
import { Appointment, AppointmentStatus, BlockedSchedule } from '../../types';
import { formatCurrency, formatDate } from '../../utils/format';

const STATUS_OPTIONS: AppointmentStatus[] = ['SCHEDULED', 'CONFIRMED', 'COMPLETED', 'CANCELED', 'NO_SHOW'];
...
export default function BarberDashboard() {
  ...
  const [removeBreakTarget, setRemoveBreakTarget] = useState<BlockedSchedule | null>(null);
  ...
  async function onSubmitBreak(data: BarberBreakPayload) {

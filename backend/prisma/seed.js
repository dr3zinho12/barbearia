  ...
  const barbers = await Promise.all([
    prisma.barber.create({
      data: {
        ...
        specialties: JSON.stringify(['Cortes modernos', 'Degradê', 'Desenhos']),
        active: true,
      },
    }),
    prisma.barber.create({
      data: {
        ...
        specialties: JSON.stringify(['Barba', 'Cortes clássicos', 'Navalha']),
        active: true,
      },
    }),
    prisma.barber.create({
      data: {
        ...
        specialties: JSON.stringify(['Sobrancelha', 'Cortes infantis', 'Coloração']),
        active: true,
      },
    }),
  ]);
